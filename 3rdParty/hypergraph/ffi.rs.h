...
namespace hypergraph {
#ifndef CXXBRIDGE1_STRUCT_hypergraph$Hypergraph
#define CXXBRIDGE1_STRUCT_hypergraph$Hypergraph
struct Hypergraph final : public ::rust::Opaque {
  ::std::size_t size() const noexcept;
...
#endif // CXXBRIDGE1_STRUCT_hypergraph$Hypergraph

::rust::Box<::hypergraph::Hypergraph> empty() noexcept;

::rust::Box<::hypergraph::Hypergraph> with_capacity(::std::size_t num_nets) noexcept;
} // namespace hypergraph
