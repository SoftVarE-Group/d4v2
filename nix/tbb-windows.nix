# Adapted from https://github.com/NixOS/nixpkgs/pull/290181 by https://github.com/expenses
{
  lib,
  stdenv,
  fetchFromGitHub,
...
stdenv.mkDerivation rec {
  ...
  cmakeFlags = [ (lib.cmakeBool "TBB_TEST" (!stdenv.targetPlatform.isWindows)) ];

  postInstall = ''
    ln -s $out/bin/libtbb12.dll.a $out/bin/libtbb.dll.a
    ln -s $out/lib/libtbb12.dll.a $out/lib/libtbb.dll.a
  '';
