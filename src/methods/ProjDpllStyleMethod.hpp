...
public:
   ...
   */
  ProjDpllStyleMethod(Config &config, std::string &meth, bool isFloat,
    ...
    m_decay_frequency = config.scoring_method_decay_freq;
    ...
    */
    ...
    m_pure_lit_elim = config.projddnnf_pure_lit_elim;
