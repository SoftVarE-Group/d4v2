...
("partitioning-heuristic-weight",boost::program_options::value<std::string>()->default_value("none"),"The heuristic used for weighted partitioning. [maxo, moms or mams]")
