...
namespace d4 {
class PartitionerKahyparMTDyn : public PartitionerManager {
 private:
 ...
 public:
  PartitionerKahyparMTDyn(Config &config, unsigned maxNodes, unsigned maxEdges,
                     unsigned maxSumEdgeSize, std::ostream &out);

  ~PartitionerKahyparMTDyn();
